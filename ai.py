...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        alien_heigth = alien.rect.y
        available_space_y = self.settings.screen_height - (2 * alien_heigth) - ship_height
        number_rows = available_space_y // (1 * alien_heigth)
        print(ship_height)
        print(number_rows)
...
if __name__ == '__main__':
    # Создание экземпляра и зупуск игры
    ai = AlienInvasion()
    ai.run_game()
